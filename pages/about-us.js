    ...
    return (
        <>
            ...
            <section className="about-content-wrap cv-auto">
                <div className="container mxw-1100 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                    <div className="about-team-block">
                        ...
                        <div className="lg-title text-uppercase mb-lg-4 mb-3 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                            Meet Our Team
                        </div>
                        <div className="common-text wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
